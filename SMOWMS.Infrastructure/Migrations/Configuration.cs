...
//                );
            ...
            context.AssTemplates.AddOrUpdate(
                new AssTemplate { TEMPLATEID = "AT20180401", IMAGE = "2014.jpg", MANAGER = "12345678912", NAME = "电脑", NOTE = "备注", PRICE = 5000, SPECIFICATION = "50*40", UNIT = "台",TYPEID = "01"},
                new AssTemplate { TEMPLATEID = "AT20180402", IMAGE = "2015.jpg", MANAGER = "12345678913", NAME = "显示器", NOTE = "备注", PRICE = 2000, SPECIFICATION = "50*40", UNIT = "台", TYPEID = "01" },
                new AssTemplate { TEMPLATEID = "AT20180403", IMAGE = "2016.jpg", MANAGER = "12345678914", NAME = "手机", NOTE = "备注", PRICE = 4000, SPECIFICATION = "50*40", UNIT = "台", TYPEID = "01" }
                );

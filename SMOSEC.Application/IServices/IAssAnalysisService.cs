...
namespace SMOWMS.Application.IServices
{
    ...
    public interface IAssAnalysisService
    {
        ...
        /// <param name="inputDto">查询的条件</param>
        /// <returns></returns>
        List<object> GetAssCustomerAnalysisEChart(QueryAssCusandVenAnalysisInputDto inputDto);
        /// <summary>
        /// 得到供应商报表
        /// </summary>
        /// <param name="inputDto">查询的条件</param>
        ...
        /// <param name="inputDto">查询的条件</param>
        /// <returns></returns>
        List<object> GetAssVendorAnalysisEChart(QueryAssCusandVenAnalysisInputDto inputDto);
        /// <summary>
        /// 得到资产库存
        /// </summary>
        /// <param name="inputDto">资产库存查询入参</param>
        ...
        /// <param name="inputDto">资产库存查询入参</param>
        /// <returns></returns>
        List<object> GetAssQuantEChart(QueryAssQuantInputDto inputDto);

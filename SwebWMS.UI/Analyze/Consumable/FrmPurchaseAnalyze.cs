...
namespace SwebWMS.UI.Analyze
{
    ...
    partial class FrmPurchaseAnalyze : Swebui.Controls.SwebUserControl
    {
        ...
        public void Bind()
        {
            ...
            Dictionary<string, decimal> result = autofacConfig.ConPurchaseOrderService.GetPurchaseAnalyze((DateTime)dpStart.Value.BeginDate, (DateTime)dpStart.Value.EndDate);

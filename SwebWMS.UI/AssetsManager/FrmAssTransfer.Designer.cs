...
namespace SwebWMS.UI.AssetsManager
{
    partial class FrmAssTransfer : Swebui.Controls.SwebUserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            gridViewColumn1.DisplayMember = "TOID";
            gridViewColumn1.HeaderText = "调拨单编号";
            gridViewColumn2.DisplayMember = "CREATEDATE";
            gridViewColumn2.HeaderText = "创建日期";
            ...
            this.panel2,
            this.gridView1});
            this.Load += new System.EventHandler(this.FrmAssTransfer_Load);
